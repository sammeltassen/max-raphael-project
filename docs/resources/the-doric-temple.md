...
[^3eda3950]:
    ...
    > _The men were broken-hearted as they heard me, and threw themselves on the ground groaning and tearing their hair, but they did not mend matters by crying. When we reached the sea shore, weeping and lamenting our fate, Circe brought the ram and the ewe, and we made them fast hard by the ship. She passed through the midst of us without our knowing it, <b>for who can see the comings and goings of a god, if the god does not wish to be seen?</b>_ The Odyssey, Book 10.573, tr Samuel Butler, 1900, [Perseus Digital Library](http://data.perseus.org/citations/urn:cts:greekLit:tlg0012.tlg002.perseus-eng2:10.13)

    In the text _VI. The Struggle to Understand Art_, written in the same year as _The Doric Temple_ and first published in The Demands of Art (1968), Raphael references the same passage when he discusses the three requirements of an active analysis of the work of art. Tracing the creative process, analysis must:
...
Each building mass [Baukörper] has three main characteristics: extension [Ausdehnung], matter [Materie] and energy [Energie]. _Extension_ it shares with any geometrical body. Its shape [Figur] is an encounter of spaces, which divides the total space into two groups, an enclosed (and designed) one and an excluded (and undesigned) one. _Matter_ it shares with all physical bodies. It doubles the aforementioned border (between in- and outside) due to which in- and outside no longer need to have the same form.[^dcdc6c08] The third characteristic, _energy_, is closely related to the second and is the play of forces, loads and supports, shearing force, buttresses, etc. The building is therefore the materially and energetically realised composition of spaces, which designs the demarcated enclosed space and its relationship to the exterior. The definition of the border will further determine the connection or division between both spaces.
...
This definition is too vague because extension, matter and energy are such general categories that no body [Körper], not even a sculptural one, could escape it. Only the study of its concretisation and relationships provides the right nuances for understanding Doric buildings as an architectural and not, as often falsely assumed, plastic body. For now the definition is sufficient however to familiarise us with the character of these elements in the Doric temple.

#### Geometric figure

##### a) Uniform structure composed of contrasting parts

The Doric Tempel is a uniform structure, i.e. the compositional fusion of two different shapes: a parallelepiped (of planes and right angles [cuboid]) and a prism (of planes and non-right angles) are fused into a shape whose front exists of 5 sides, and the total volume of 2 layers.[^bdb3b345] The first is the-quantitatively dominating–foundation, the other the-spiritually concluding-crown. The compositional fusion of the figural unity is achieved by \[1] the diagonals that extend over the corners of the steps into the depth of the Pteron [peristyle] and further into the columns of the Antenfront[^MR-3], the \[2] concave upward movement, which–beginning at the stepped corners–anticipates the pediment through the tapering and slanting of the columns and beams; and finally \[3] by the ridge connecting both pediments, parallel to the central depth axis.

[^bdb3b345]: Misprint in both the original publication and WA: 7 instead of 2. ^JS
[^MR-3]: This compositional preparation of the pediment is clearly visible at the Poseidontempel, while lacking in others. ^MR

The idea of a building composed of two opposites into a unity-one could also say: disintegrated from a unity-only becomes clear through a comparison with the simple structure of the Egyptian pyramid and the composite structure of the Christian church. In the pyramid, four coherent and unarticulated planes lean toward each other over a square plan until they converge into four borders and a point, so that each of the slanting surfaces becomes an isosceles triangle. The geometric simplicity is even greater in for example the Colosseum, where the oval shape determines the articulation of the upper floors, and is not replaced by another figure. In contrast, the Romanesque church is assembled from multiple cuboids stretching in all three directions, where the assembly of the geometry is determined by a transcendental principle and pure religious view: i.e. after the shape of the cross.

##### b) Proportion

These opposite elements, as well as the uniform figure originating from their fusion, were proportionally linked for the Greeks. First it should be emphasised that e.g. 12 temples[^MR-4] of greater Greece fall into two schools of shared proportions[^MR-4a]. This corresponds to the limited themes of Greek tragedy or the few principles of Presocratic philosophy. My assumption for the group of larger temples is $200 * 80 * 30$ foot for the depth and width of the Stylobat and the height of the columns; for the smaller temples, these measurements are $115 * 45 * 15$. The Greek foot measures either $0.296$ (for example at the Poseidontempel in Paestum) or $0.350$ (for example at the Juno and Concordia tempel in Akragas). All deviations can be explained on the basis of the individuality of the artistic conception that was realised in the building.

<figure>
<div id="map" style="height: 400px; width:100%; z-index: 1;"></div>
<figcaption>Map of the 12 Doric Temples measured by Raphael in <a href="https://en.wikipedia.org/wiki/Magna_Graecia">Magna Graecia</a>. Zoom to: 
...
<a id="segesta-link" href="javascript:void(0)">Segesta</a> (<a id="reset-link" href="javascript:void(0)">reset</a>).
...
The order of the dimensions by quantity is: depth, width, height. This means that the earthly dimension of occurences and their equality {>>die irdische Dimension der Geschehnisse und ihrer Ebenbürtigkeit<<}, which cannot be escaped even by the movement of the head, is the axis for the relationship between the other two dimensions. Often the ratio between the depth and the width of the Stylobat is close to the golden ratio, and relate to each other like the small part to the whole [$80:200 = 2:5$]. And often the overall height [of the pediment] is the greater part of the subdivided smaller part [$80$ subdivided into $50$ and $30$; the column height is $30$. The width is the small part of the depth, and the height of columns is the small part of the width. The pediment tip is $50$.] The golden section, which plays an important part in the Doric Tempel for both the line segments {>>strecken<<} and the angles in the approximations $2 : 3 = 3 : 5$ and $3 : 5$ and $5 : 8$, has the follwing characteristics: it creates a relationship between unequal parts which simultaneously expresses their relationship to the whole structure; it describes the possibilities for the equilibrium between predominantly static and predominantly dynamic divisions. It therefore is an immanent, all-round, design-determining proportion.
...
[^01cd8d99]: _genesis eis ousian_ - Schöpfung gemaß der Substanz. ousia ist die erste der zehn aristotelischen Kategorien. Raphael hatte wahrscheinlich »Wesensschöpfung« übersetzt. ^WA
...
Important for architecture are the selection, ordening and articulation of individual forces and their combined forms. Out of pure empirical grounds, I distinguish between the following kind of energies: the spatial-functional, the material-static and psychological-expressive. The material-static include the rotating, centrifugal, centripetal, normal, trust, sloping [Neigung] and bending forces. The relation between forces are general-mechanically: action [Angriff], reaction [Ruckwirkung] (impost, _Widerlager_ [?]) and balance; optically: visible and invisible; material: mass or ray [?] forces; aesthetically: touch, penetration, resolution (free or bound), smoothing, breaking up.
